...
jsonFile = open(os.path.join(path_processed_data, 'covid_filtered_ner_train_v3.json'), "r")
...
X_train = details_dict['ner_filtered']

jsonFile = open(os.path.join(path_processed_data, 'covid_filtered_ner_valid_v3.json'), "r")
jsonContent = jsonFile.read()
details_dict = json.loads(jsonContent)
jsonFile.close()

Y_valid = details_dict['headlines']
X_valid = details_dict['ner_filtered']


jsonFile = open(os.path.join(path_processed_data, 'covid_filtered_ner_test_v3.json'), "r")
jsonContent = jsonFile.read()
details_dict = json.loads(jsonContent)
jsonFile.close()

Y_test = details_dict['headlines']
X_test = details_dict['ner_filtered']
...
number_of_batches = 74063//batch_size_train
...
for i in range(number_of_batches):
    ...
    model_filename = "model_ner_filtered_bart" + str(count) + "_" + str(start_offset_train) + "_" + str(end_offset_train) + "_" + str(epocs) + "e.pkl"
    ...
    results_file = open(os.path.join(path_models, "results_ner_filtered_bart.txt"), "a")
